...
namespace MES.Infrastructure.Migrations
{
    ...
    [Migration("20260413114838_AddUserGroupPermissionsTable")]
    partial class AddUserGroupPermissionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MES.Domain.Entities.Orders.ProductionOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ActualBatch")
                        .HasColumnType("int");

                    b.Property<DateTime?>("BatchEnd")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("BatchStart")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MES.Domain.Entities.Recipes.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MES.Domain.Entities.Recipes.RecipeItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("ToleranceNegative")
                        .HasColumnType("float");

                    b.Property<double>("TolerancePositive")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MES.Domain.Entities.Orders.ProductionOrder", b =>
                {
                    b.HasOne("MES.Domain.Entities.Recipes.Recipe", "Recipe")
                        .WithMany()
